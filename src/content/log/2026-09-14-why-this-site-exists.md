...
- **The log** tracks progress. I'll add a post when enough has happened, or when something particularly interesting
  gets finished.
- **Projects** describe each part of the system and how it fits with the others.
- **Decisions** record the design choices, what else I considered, and what tipped it.

Photos of the layout will follow once I've managed to take some decent ones.
